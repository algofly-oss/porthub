...
def serialize_connection(connection: dict, machine: dict | None = None):
    ...
    serialized = {
        ...
        "auto_refresh_enabled": connection.get("auto_refresh_enabled", False),
        "auto_refresh_interval_minutes": connection.get("auto_refresh_interval_minutes"),
        "auto_refreshed_at": connection.get("auto_refreshed_at"),
        "auto_refresh_next_at": connection.get("auto_refresh_next_at"),
