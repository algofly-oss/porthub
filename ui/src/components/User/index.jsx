...
export default function UserHome() {
  ...
  return (
    <div className="flex">
      <aside
        className="bg-neutral-100 dark:bg-black flex items-center w-full md:flex-col md:items-stretch md:px-4 fixed inset-x-0 bottom-0 z-10 h-16 md:h-screen md:w-52 2xl:w-72 md:p-4 md:overflow-y-auto md:light-scrollbar dark:md:dark-scrollbar"
      >
        <div
